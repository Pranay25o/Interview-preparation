export const BASE_URL = "https://interview-preparation-ivmx.onrender.com";
...
export const API_PATHS = {
  ...
  AI: {
    GENERATE_QUESTIONS: "/api/ai/generate-question", // Generate interview questions
  ...
  QUESTION: {
    ...
    UPDATE_NOTE: (id) => `/api/questions/${id}/note`, // Update/Add a note to a quest
  },
};
