...
<div className="fle items-center justify-between px-4 py-2 bg-gray-100 border-b  border-gray-200">
            ...
            {language || 'Code'}
             ...
             <button
                ...
                aria-label="Copy code">
                    ...
                    {copied && (
                    <span className="absolute top-8  right-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transison">
                        Copied!
                    </span>
                    )}
