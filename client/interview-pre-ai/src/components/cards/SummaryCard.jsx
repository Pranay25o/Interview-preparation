...
const SummaryCard = ({
    ...
    // This function stops the parent onClick from firing when the delete button is clicked.
    ...
    return (
        <div className='group bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100  relative' onClick={onSelect} >
          ...
          <div className='px-3 pb-3'>
            <div className='flex items-center gap-3 mt-4'>
              <div className='text-[10px] font-medium text-black px-3 py1 border-[0.5px] border-gray-900 rounded-full'>
